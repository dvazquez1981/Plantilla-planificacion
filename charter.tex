...
\begin{figure}[htpb]
  \begin{center}
    \begin{ganttchart}[
      time slot unit=day,
      time slot format=isodate,
      x unit=0.12cm,            % mismo ancho de día en ambas figuras
      y unit title=0.6cm,
      y unit chart=0.5cm,
      group label font=\scriptsize,
      bar label font=\tiny
      ...
      % Fases principales
      \ganttgroup{1. Análisis y diseño}{2025-05-01}{2025-05-22} \\
      ...
      % Gestión y coordinación (como BARRAS para que cuadren exactamente)
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{14. Gestión y coord.}{2025-05-21}{2025-05-22} \\
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{}{2025-06-05}{2025-06-06} \\
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{}{2025-07-01}{2025-07-06} \\
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{}{2025-07-13}{2025-07-13} \\
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{}{2025-07-18}{2025-07-18} \\
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{}{2025-08-10}{2025-08-11} \\

    \end{ganttchart}
  \end{center}
  \caption{\small Diagrama de Gantt parte 1 (sin subtareas).}
  \label{fig:gantt1}
\end{figure}
...
\begin{figure}[htpb]
  \begin{center}
    \begin{ganttchart}[
      time slot unit=day,
      time slot format=isodate,
      x unit=0.12cm,            % mismo ancho de día aquí también
      y unit title=0.6cm,
      y unit chart=0.5cm,
      group label font=\scriptsize,
      bar label font=\tiny
      ...
      \ganttgroup{12. Integración del sistema}{2025-09-21}{2025-10-04} \\
      \ganttgroup{13. Pruebas del sistema}{2025-10-05}{2025-10-18} \\
      \ganttgroup{15. Cierre del proyecto}{2025-10-19}{2025-10-23} \\

      % Gestión y coordinación (continuación)
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{14. Gestión y coord.}{2025-08-15}{2025-08-16} \\
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{}{2025-08-19}{2025-08-20} \\
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{}{2025-09-10}{2025-09-11} \\
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{}{2025-09-15}{2025-09-16} \\
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{}{2025-09-19}{2025-09-20} \\
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{}{2025-09-30}{2025-10-04} \\
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{}{2025-10-17}{2025-10-18} \\
      \ganttbar[bar/.append style={fill=cyan!40, draw=black}]{}{2025-10-23}{2025-10-23} \\

    \end{ganttchart}
  \end{center}
  \caption{\small Diagrama de Gantt parte 2 (sin subtareas).}
  \label{fig:gantt2}
\end{figure}
