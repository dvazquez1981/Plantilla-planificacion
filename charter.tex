...
\autor{Ing. Diego Anibal Vazquez}
...
Este proyecto surge en el marco de una necesidad operativa concreta detectada en la infraestructura actual de monitoreo de tránsito vehicular utilizada en rutas nacionales. 
Actualmente, un modelo de los contadores de tránsito empleados han sido desarrollados internamente y cumplen adecuadamente su función básica: registrar el paso de vehículos, clasificar en livianos y pesados y transmitir los datos a un servidor central. 
Sin embargo, estas unidades se comunican exclusivamente por enlaces GPRS tercerizados, a través de un canal unidireccional, lo que impide cualquier tipo de interacción remota con los dispositivos en campo.
Frente a esta situación, se plantea el desafío de modernizar la arquitectura de comunicaciones de estos sistemas, incorporando capacidades de comunicación bidireccional, diagnósticos remotos y rapida respuesta operativa. Este proyecto se enmarca en una iniciativa profesional orientada a mejorar el proceso de calculo de estadísticas viales y optimizar la eficiencia operativa en el control de tránsito.
...
Existen en el mercado soluciones comerciales con capacidades de gestión remota y comunicación bidireccional. Sin embargo, muchas de estas soluciones son costosas. El enfoque propuesto busca aprovechar tecnologías de código abierto y protocolos estandarizados (MQTT sobre TLS) para construir una solución flexible, escalable y económicamente viable, adaptada al entorno específico de rutas argentinas.

\subsection{Propuesta de Modernización}

Se propone rediseñar el sistema de comunicaciones de los contadores de tránsito, incorporando un modelo de comunicación bidireccional segura. Este nuevo esquema permitirá no solo el envío de datos desde los dispositivos hacia el servidor central, sino también la recepción de comandos y actualizaciones desde el servidor hacia los dispositivos en campo. Adicionalmente, se prevé la visualización de los datos en tiempo real, a medida que vayan siendo transmitidos.

\subsection{Descripción Funcional y Técnica}
El sistema estará compuesto por:
\begin{itemize}

\item Un dispositivo contador (ya desarrolado pero incompleto) modificado para incluir capacidad de comunicación bidireccional.
...
\item Una interfaz web básica alojada en el servidor central, que permitirá visualizar en tiempo real los datos capturados y enviar comandos a los dispositivos (reinicio, carga de parametros, consulta de estado).
...
El cliente es Vialidad Nacional interesada en modernizar sus sistemas de conteo de tránsito. Valora la autonomía operativa, la posibilidad de diagnóstico remoto, y la reducción de costos operativos.
No existen condiciones especiales en cuanto a propiedad intelectual ni confidencialidad en esta etapa.

\subsection{Grado de Innovación}
La innovación del proyecto reside en la integración de elementos existentes (sensores, redes móviles) bajo una lógica de arquitectura abierta y centralizada, adaptable y orientada a la gestión inteligente de los datos del tránsito, con fuerte énfasis en la autonomía y la flexibilidad operativa.
...
Colaboradores & Inga. María Clara Cuttrone    &\empclientename             	&Jefa Sección Análisis Tránsito      	\\ \hline
...
\begin{itemize}
	...
	\item Colaborador: Inga. María Clara Cuttrone, suele pedir licencia porque tiene familia extensa. Planificar considerando esto.
\end{itemize}
...
Diseñar e implementar un sistema capaz de registrar eventos de tránsito, permitir la transmisión segura de los datos recolectados, incluso ante cortes de conexión. Además, se busca incorporar capacidades de comunicación bidireccional que habiliten diagnósticos y carga de parametros remotos y una mejor respuesta ante fallas. Con esto, se pretende mejorar la calidad de la información recolectada en rutas nacionales y facilitar el trabajo de los equipos técnicos responsables del monitoreo.
