...
r de 60 horas para imprevistos:
...
\item Revisión y validación del diseño con stakeholders (15 h)
\end{enumerate}
...
\begin{enumerate}
\item Implementación de recepción de datos por RS-232 (15 h)
...
\item Pruebas de compatibilidad con diferentes clientes (5 h)
\end{enumerate}
...
\item Comunicación con stakeholders y reporte de avances (5 h)
\end{enumerate}
...
\item Monitoreo y soporte post-despliegue (15 h)
\item Corrección de errores y ajustes finales (15 h)
\end{enumerate}
\item \textbf{Buffer para Imprevistos (60 h)}
\begin{enumerate}
\item Tiempo reservado para manejar retrasos, cambios de alcance o problemas técnicos no previstos.
\end{enumerate}
\end{enumerate}
