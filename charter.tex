...
\textbf{Supuestos:}
\begin{itemize}
    \item Se trabaja 4 horas por día, sin contar los fines de semana.
    \item Las tareas mayormente son secuenciales porque se es el único recurso.
    \item La parte de gestión se hace en paralelo.
\end{itemize}
...
Riesgo 6: incompatibilidad del protocolo RS232 con el contador desarrollado por María Clara Cuttrone
\begin{itemize}
\item Severidad (S): 7\\
...
Riesgo 6: incompatibilidad protocolo RS232 con contador
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Análisis del respeto al Plan de Proyecto original:} \\
    Responsable: El Jefe de Proyecto será el encargado de esta tarea. \\
    Procedimiento: Se revisará el cronograma inicial, los entregables planificados y los resultados obtenidos mediante la comparación con reportes de avance y actas de reuniones anteriores. Se utilizarán herramientas de gestión de proyectos para identificar desviaciones y causas. Se documentará el análisis en un informe para presentar en la reunión.

    \item \textbf{Identificación de técnicas y procedimientos útiles e inútiles, problemas y soluciones:} \\
    Responsable: El Coordinador de Calidad y el equipo de trabajo colaborarán en esta tarea. \\
    Procedimiento: Se convocará a una sesión de retroalimentación donde cada integrante comentará sobre las técnicas aplicadas. Se recopilarán problemas surgidos y sus soluciones mediante actas o minutas. Posteriormente, se consolidará un documento con lecciones aprendidas que se archivará para futuros proyectos.

    \item \textbf{Organización del acto de agradecimiento a interesados, equipo y colaboradores:} \\
    Responsable: El Departamento de Recursos Humanos organizará el acto. \\
    Financiamiento: Los gastos serán cubiertos por el presupuesto asignado al área de gestión de proyectos, aprobados por la dirección. \\
    Procedimiento: Se coordinará la logística del evento, envío de invitaciones y agradecimientos formales a todos los involucrados.
